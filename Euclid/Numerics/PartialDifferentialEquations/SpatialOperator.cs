...
namespace Euclid.Numerics.PartialDifferentialEquations
{
    public class SpatialOperator
    {
        ...
        public SpatialOperator(Matrix operatorMatrixX, Matrix operatorMatrixY, Matrix operatorMatrixXY,Vector boundaryVectorX, Vector boundaryVectorY, Vector boundaryVectorXY, int lowerBandwidth, int upperBandwidth)
        {
