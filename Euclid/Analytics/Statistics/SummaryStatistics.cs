namespace Euclid.Analytics.Statistics
{
    ...
    public sealed class SummaryStatistics
    {
        ...
        private SummaryStatistics(double min, double average, double max, double stdev, double range, double percentile10, double median, double percentile90, int count, double skewness, double kurtosis, double sum)
        {
        ...
        #region methods
        /// <summary>Create a <c>SummaryStatistics</c></summary>
        /// <param name="min">Minimum</param>
        /// <param name="average">Average</param>
        /// <param name="max">Maximum</param>
        /// <param name="stdev">Standard deviation</param>
        ...
        /// <param name="kurtosis">Kurtosis</param>
        /// <param name="sum">Sum of elements</param>
        public static SummaryStatistics Create(double min, double average, double max, double stdev, double range, double percentile10, double median, double percentile90, int count, double skewness, double kurtosis, double sum)
        { return new SummaryStatistics(min, average, max, stdev, range, percentile10, median, percentile90, count, skewness, kurtosis, sum); }
        /// <summary>
        /// Print main statistics from the summary
        /// </summary>
        /// <returns></returns>
        public override string ToString() { return $"{Min};{Average};{Median};{Max};{Stdev};{Count}"; }
        #endregion
    }
}
