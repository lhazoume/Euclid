...
namespace Euclid.Benchmarking
{
    public class CaseResult : IXmlable
    {
        ...
        private static ManagementObjectSearcher _baseboardSearcher = new ManagementObjectSearcher("root\\CIMV2", "SELECT * FROM Win32_BaseBoard"),
        ...
        public CaseResult FromXml(XmlNode node)
        {
            ...
            return new CaseResult(name, 0, new TimeSpan(0), 0, DateTime.MinValue,motherBoard, processor, gpu);
        }
        #endregion
