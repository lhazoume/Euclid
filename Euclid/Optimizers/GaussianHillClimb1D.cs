...
namespace Euclid.Optimizers
{
    ...
    public class GaussianHillClimb1D
    {
        ...
        private readonly double _lowerBound, _uppperBound, _sigma0, _gamma;
        ...
        public GaussianHillClimb1D(double initialGuess, Func<double, double> f,
            OptimizationType optimizationType,
            double lowerBound, double upperBound, double sigma0, double gamma,
            int iterations)
        {
        ...
        public GaussianHillClimb1D(double initialGuess, Func<double, double> f,
            ...
            int iterations)
            : this(initialGuess, f, optimizationType, lowerBound, upperBound,
        ...
        public void Optimize()
        {
            ...
            for (int i = 0; i < _iterations; i++)
            {
                ...
                while (randomPoint >= _uppperBound || randomPoint <= _lowerBound);
                #endregion

                double newValue = _f(randomPoint);
