...
{
    public class DistributionExample1
    {
        public static void Run()
        {
            Console.OutputEncoding = System.Text.Encoding.UTF8;
            Console.WriteLine("Code exécuté depuis DistributionExample !");

            BinomialDistributionExample();
            PoissonDistributionExample();
            SkellamDistributionExample();

            ExponentialDistributionExample();
            CauchyDistributionExample();
            UniformDistributionExample();
            NormalDistributionExample();
        }

        static void BinomialDistributionExample()
        {
        ...
        static void PoissonDistributionExample()
        {
        ...
        static void SkellamDistributionExample()
        {
        ...
        static void ExponentialDistributionExample()
        {
            // Distribution parameter
            double lambda = 0.4;
        ...
        static void CauchyDistributionExample()
            {
                // Distribution parameters
                double x0 = 4.0;
                double gamma = 6.0;
        ...
        static void UniformDistributionExample()
        {
            // Distribution parameters
            double a = 2.0;
            double b = 5.0;
        ...
        static void NormalDistributionExample()
            {
                // Distribution parameters
                double mu = 2.0;
                double sigma = 1.5;
